...
morekeywords={frametitle,framesubtitle,href,uselanguage,languagepath,subtitle,column},
otherkeywords={pause,usetheme,usecolortheme,useinnertheme,titlepage,tableofcontents},
breaklines=true,
...
\newcommand{\enlace}[3]{\textbf{\href{#1}{#2}} - {\small #3}}  % Estílo único para refs
