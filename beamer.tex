...
morekeywords={frametitle,framesubtitle, href, uselanguage, languagepath},
otherkeywords={pause, column},
breaklines=true,
...
\newcommand{\espacio}{\vspace*{2\baselineskip}}        % tex.stackexchange.com/questions/11622
...
\seccion{generando.tex}   % Generando la presentacin
